...
const OwnerTambahPembelianSupply = () => {
    ...
    const dummyData = {
        supplierId: 1,
        tanggalSupply: '2025-05-01',
        nomorInvoice: 'INV-123456',
        gambar_invoice: '/images/supply-invoices/kwitansi.jpg',
        produk: [
            {
                produk: '1',
                jumlah: '400',
    ...
    const [selectedSupplier, setSelectedSupplier] = useState<number>(dummyData.supplierId);
    const [tanggalSupply, setTanggalSupply] = useState<string>(dummyData.tanggalSupply);
    const [nomorInvoice, setNomorInvoice] = useState<string>(dummyData.nomorInvoice);
    const [rows, setRows] = useState<ProdukRow[]>(dummyData.produk);
    const [preview, setPreview] = useState<string | null>(dummyData.gambar_invoice);
        ...
        <OwnerLayout>
            ...
            <div className="flex justify-center py-8 text-black">
                <div className="mx-auto w-15/17 rounded-lg bg-white p-6 shadow-md">
                    ...
                    <h1 className="mb-6 text-center text-2xl font-bold">Edit Pesanan Supply</h1>
