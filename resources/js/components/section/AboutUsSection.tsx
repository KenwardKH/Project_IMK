                    ...
                    <div className="grid items-center gap-16 lg:grid-cols-2">
                        <div className="space-y-8">
                            ...
                            <div className="prose prose-lg space-y-6 text-gray-700">
                                <p>
                                    Dimulai pada tahun 1990, Sinar Pelangi ATK lahir dari visi sederhana: menyediakan alat tulis kantor berkualitas
                                    dengan harga terjangkau untuk mendukung pendidikan dan produktivitas masyarakat Indonesia.
                                </p>

                                <p>
                                    Dari sebuah toko kecil di Jakarta, kami telah berkembang menjadi distributor ATK terpercaya yang melayani berbagai
                                    kalangan, mulai dari pelajar, mahasiswa, hingga perusahaan besar di seluruh Indonesia.
                                </p>

                                <p>
                                    Kepercayaan pelanggan adalah aset terbesar kami. Selama 35 tahun, kami konsisten memberikan pelayanan terbaik dan
                                    terus berinovasi untuk memenuhi kebutuhan ATK yang terus berkembang.
                                </p>
                            </div>
                        </div>
